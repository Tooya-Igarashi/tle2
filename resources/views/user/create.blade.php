<x-app-layout class="text-white">
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            {{-- DESCRIPTION --}}
            <div>
                <label class="font-semibold text-white">Beschrijven</label>
            ...
            {{-- DIFFICULTY --}}
            <div>
                <label class="font-semibold text-white">Moeilijkheid</label>
            ...
            {{-- Image --}}
            <div>
                <label class="font-semibold text-white">Foto</label>
            ...
            {{-- Duration --}}
            <div>
                <label class="font-semibold text-white">Hoe lang duurt dit? (Uren:Minuten)</label>
            ...
            <div id="stepsContainer" class="{{ old('steps') ? '' : 'hidden' }} space-y-4">
                ...
                <div class="flex justify-between items-center">
                    <h3 class="font-bold text-lg text-white">Stappen</h3>
                        ...
                        @foreach(old('steps') as $index => $step)
                            <div class="step-item border border-gray-300 p-4 rounded mb-4">
                                <div class="step-header flex justify-between items-center mb-2">
                                    <span class="step-title font-semibold text-white">Stap {{ $index + 1 }}</span>
                                    <button type="button"
